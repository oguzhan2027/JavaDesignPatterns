...
public class Ev {
    ...
    public Ev(String il, String ilce, String mahalle, int binaYili,
            int balkonSayisi, int odaSayisi, int banyoSayisi, int tuvaletSayisi,
            boolean isDublex, boolean isEsyali, boolean hasOtopark,
    ...
    public boolean isIsEsyali() {
        return isEsyali;
    }

    public void setIsEsyali(boolean isEsyali) {
        this.isEsyali = isEsyali;
    }
    ...
    public String toString() {
        return "Ev{" + "il=" + il + ", ilce=" + ilce + ", mahalle=" + mahalle + ","
                + " binaYili=" + binaYili + ", balkonSayisi=" + balkonSayisi + ","
                + " odaSayisi=" + odaSayisi + ", banyoSayisi=" + banyoSayisi + ","
                + " tuvaletSayisi=" + tuvaletSayisi + ", isDublex=" + isDublex + ","
                + " isEsyali=" + isEsyali + ", hasOtopark=" + hasOtopark + ","
                + " hasCocukParki=" + hasCocukParki + ", hasKlima=" + hasKlima + ","
                + " hasHavuz=" + hasHavuz + '}';
    }
